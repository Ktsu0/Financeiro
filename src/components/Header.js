  ...
  return (
    <header className="relative overflow-hidden border-b border-white/5 bg-card/30 backdrop-blur-md">
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-12 py-5 sm:py-8 lg:py-10 relative">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-6 mb-5 sm:mb-8 lg:mb-10">
          <motion.div
          ...
          >
            <div className="flex items-center gap-2 sm:gap-3 mb-1.5 sm:mb-2">
              ...
              <h1
                className="text-xl sm:text-3xl font-extrabold tracking-tight font-heading text-white"
                data-testid="app-title"
              >
                <span className="animate-rgb">Minhas Finanças</span>
              </h1>
            </div>
            <p className="text-[10px] sm:text-sm text-muted-foreground font-body max-w-xs">
          ...
          >
            <button
              ...
              className="group relative p-2.5 sm:p-4 bg-white/5 hover:bg-primary/10 border border-white/10 hover:border-primary/30 rounded-xl sm:rounded-[1.5rem] transition-all duration-300 flex items-center gap-2 sm:gap-3 overflow-hidden shadow-lg"
              title="Configurações"
            >
              ...
              <Settings
                ...
                size={18}
              />
              <span className="hidden sm:block text-xs sm:text-sm font-bold text-white/70 group-hover:text-white transition-colors">
                Ajustes
              </span>
            </button>
          </motion.div>
        ...
        >
            ...
            <div className="relative flex items-start justify-between">
              <div className="space-y-2 sm:space-y-4 flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-[9px] sm:text-xs font-bold uppercase tracking-widest text-muted-foreground">
                    Capital Disponível
                  </p>
                </div>
                <div>
                  <h2
                    className="text-2xl sm:text-4xl lg:text-5xl font-extrabold font-heading tracking-tight text-white mb-1"
              ...
              <div className="flex flex-col gap-2 ml-2">
                <div className="p-2 sm:p-3 lg:p-4 bg-primary text-primary-foreground rounded-lg sm:rounded-2xl shadow-xl shadow-primary/20">
                  <TrendingUp
                    size={16}
                    strokeWidth={2.5}
                ...
                <button
                  ...
                  className="p-1.5 bg-white/5 hover:bg-white/10 text-white/50 hover:text-white rounded-lg sm:rounded-xl transition-all flex items-center justify-center"
          ...
          >
            ...
            <div className="relative flex items-start justify-between">
              <div className="space-y-2 sm:space-y-4 flex-1">
                <div className="flex items-center gap-2">
                  <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-destructive animate-pulse" />
                  <p className="text-[9px] sm:text-xs font-bold uppercase tracking-widest text-muted-foreground">
                    Total Comprometido
                  </p>
                </div>
              ...
              <div className="p-2 sm:p-3 lg:p-4 bg-destructive text-destructive-foreground rounded-lg sm:rounded-2xl shadow-xl shadow-destructive/20 ml-2">
                <TrendingDown
                  size={16}
                  strokeWidth={2.5}
                  className="sm:w-6 sm:h-6"
